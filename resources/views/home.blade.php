    ...
    <section id="projects" class="py-20 relative">
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">Beberapa projek terbaru yang menunjukkan pendekatan saya
                    dalam development</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                @foreach($featuredProjects as $project)
                    <a href="{{ route('projects.show', $project['slug']) }}" class="group block">
                        <div
                            class="bg-dark-tertiary rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-800/50 hover:border-navy-500/50 transform hover:-translate-y-2 h-full flex flex-col">
                            ...
                            <div class="p-6 flex-grow flex flex-col">
                                ...
                                <div class="flex flex-wrap gap-2 mb-4">
                                    @foreach($project['tags'] as $tag)
                                        <span
                                            class="px-3 py-1 bg-gray-800 text-gray-300 rounded-full text-sm font-medium border border-gray-700">{{ $tag }}</span>
                                    @endforeach
                                </div>
                                <div
                                    class="inline-flex items-center text-navy-400 font-medium group-hover:text-navy-300 transition-colors mt-auto">
                                    Lihat Detail
            ...
            <div class="text-center mt-12">
                <a href="{{ route('projects') }}"
                    class="inline-flex items-center px-6 py-3 border border-gray-700 text-gray-300 rounded-xl font-medium hover:border-navy-500 hover:text-white transition-all duration-300 transform hover:-translate-y-1">
                    Lihat Semua Projek
