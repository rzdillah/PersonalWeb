    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="flex justify-between items-center mb-6 p-4 bg-navy-500/10 rounded-xl border border-navy-500/20">
            <div class="flex items-center space-x-4">
                ...
                <span class="text-gray-600">•</span>
                <a href="{{ route('projects.show', $project->slug) }}" target="_blank" class="text-sm text-blue-400 hover:text-blue-300 transition-colors">
                    View Live
                </a>
            </div>
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-400 mt-2">Update project details</p>
        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="category" 
                                ...
                                <option value="tools" {{ old('category', $project->category) == 'tools' ? 'selected' : '' }}>Tools & Systems</option>
                                <option value="ai" {{ old('category', $project->category) == 'ai' ? 'selected' : '' }}>AI & Machine Learning</option>
                                <option value="design" {{ old('category', $project->category) == 'design' ? 'selected' : '' }}>Design System</option>
                            </select>
                        </div>
                ...
                <div class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 bg-dark-secondary border border-gray-700 rounded-xl focus:ring-2 focus:ring-navy-500 focus:border-navy-500 transition-all duration-300 text-white placeholder-gray-500"
                                  placeholder="Brief project description (max 500 characters)">{{ old('description', $project->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="full_description" 
                                  ...
                                  rows="6"
                                  class="w-full px-4 py-3 bg-dark-secondary border border-gray-700 rounded-xl focus:ring-2 focus:ring-navy-500 focus:border-navy-500 transition-all duration-300 text-white placeholder-gray-500"
                                  placeholder="Detailed project description...">{{ old('full_description', $project->full_description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="challenges" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 bg-dark-secondary border border-gray-700 rounded-xl focus:ring-2 focus:ring-navy-500 focus:border-navy-500 transition-all duration-300 text-white placeholder-gray-500"
                                  placeholder="Key challenges faced (comma separated)">{{ old('challenges', $project->challenges ? implode(', ', $project->challenges) : '') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="solutions" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 bg-dark-secondary border border-gray-700 rounded-xl focus:ring-2 focus:ring-navy-500 focus:border-navy-500 transition-all duration-300 text-white placeholder-gray-500"
                                  placeholder="Solutions implemented (comma separated)">{{ old('solutions', $project->solutions ? implode(', ', $project->solutions) : '') }}</textarea>
                    </div>
                </div>
